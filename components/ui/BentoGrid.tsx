  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(132,132,207,1) 35%, rgba(0,212,255,1) 100%)",
      }}
    >
      <div className={`&{id===6} && 'flex justify-center h-full`}>
        ...
        <div
          className={cn(
            titleClassName,
            "group-hover/ bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 kg:p-10"
          )}
        >
